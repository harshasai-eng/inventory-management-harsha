...
# Restocking orders are created at runtime via POST /api/restocking-orders (not loaded
# from a JSON file) and start empty each server run, matching the in-memory-only pattern.
restocking_orders = []
